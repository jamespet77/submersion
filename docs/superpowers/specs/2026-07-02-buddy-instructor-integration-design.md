...
- Bump `currentSchemaVersion` to 98; append `98` to `migrationVersions`.
- Test: `test/core/database/migration_v98_buddy_roles_test.dart`.
...
- `migration_v98_buddy_roles_test.dart`: table creation, column add,
