...
// in submersion/test/features/media/data/services/network_credentials_service_test.dart.
...
/// A class which mocks [NetworkCredentialsRepository].
///
/// See the documentation for Mockito's code generation for more information.
class MockNetworkCredentialsRepository extends _i1.Mock
    implements _i5.NetworkCredentialsRepository {
  MockNetworkCredentialsRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<String> upsert({
  ...
  @override
  _i4.Future<_i7.NetworkCredentialHost?> findByHostname(String? hostname) =>
      (super.noSuchMethod(
            Invocation.method(#findByHostname, [hostname]),
            returnValue: _i4.Future<_i7.NetworkCredentialHost?>.value(),
          )
          as _i4.Future<_i7.NetworkCredentialHost?>);

  @override
  _i4.Future<_i7.NetworkCredentialHost?> findById(String? id) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<void> touchLastUsed(String? id) =>
      (super.noSuchMethod(
            Invocation.method(#touchLastUsed, [id]),
            returnValue: _i4.Future<void>.value(),
            returnValueForMissingStub: _i4.Future<void>.value(),
          )
          as _i4.Future<void>);
