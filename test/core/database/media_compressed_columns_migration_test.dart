...
void main() {
  ...
  test('v132 is the current schema version (exact-latest tripwire)', () {
    ...
    // a fresh exact test when a later migration lands on top of v132.
    // (Renumbered from v130 as main advanced past it at merge time.)
    expect(AppDatabase.currentSchemaVersion, 132);
